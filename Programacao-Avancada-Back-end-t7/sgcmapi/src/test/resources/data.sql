...
INSERT INTO `atendimento` VALUES
    (DEFAULT,'2025-10-01','14:00:00','AGENDADO',1,1,1),
    (DEFAULT,'2025-10-01','14:30:00','AGENDADO',2,2,2),
    (DEFAULT,'2025-10-02','14:30:00','AGENDADO',3,3,3),
    (DEFAULT,'2025-10-02','15:00:00','AGENDADO',1,4,4),
    (DEFAULT,'2025-10-03','15:00:00','AGENDADO',2,1,1),
    (DEFAULT,'2025-10-03','16:00:00','AGENDADO',3,2,1),
    (DEFAULT,'2025-10-06','15:30:00','AGENDADO',1,3,2),
    (DEFAULT,'2025-10-06','16:30:00','AGENDADO',2,4,2),
    (DEFAULT,'2025-10-07','17:00:00','AGENDADO',3,5,5),
    (DEFAULT,'2025-10-07','17:30:00','AGENDADO',1,2,3),
    (DEFAULT,'2025-10-07','18:00:00','AGENDADO',3,3,1),
    (DEFAULT,'2025-10-08','17:00:00','AGENDADO',1,3,5),
    (DEFAULT,'2025-10-08','17:30:00','AGENDADO',1,4,5),
    (DEFAULT,'2025-10-09','18:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2025-10-09','18:30:00','AGENDADO',1,1,5),
    (DEFAULT,'2025-10-10','15:00:00','AGENDADO',1,4,4),
    (DEFAULT,'2025-10-10','15:00:00','AGENDADO',2,1,1),
    (DEFAULT,'2025-10-13','16:00:00','AGENDADO',3,2,1),
    (DEFAULT,'2025-10-13','15:30:00','AGENDADO',1,3,2),
    (DEFAULT,'2025-10-13','16:30:00','AGENDADO',2,4,2);
...
INSERT INTO `usuario` VALUES
    (DEFAULT,TRUE,'Administrador','admin','ROLE_ADMIN','$2a$10$h.s3BmgI2/N0MuDYEiawsOYh1P8l7gUcKRY6nhlDqnfcgHTv9Eb7S'),
    (DEFAULT,TRUE,'Daniel','daniel','ROLE_ADMIN','$2a$10$8b4pxEEFWXleegyJRhopLO748ONErS6gNpw8MkzldN7KU0jM6hjK.'),
    (DEFAULT,TRUE,'Teste','teste','ROLE_ATENDENTE','$2a$10$66Pd4cJ90qXZYPpVk.8ST.vu6OeOPq3/hEy42JHfJnP/QS7xxa5LS');
