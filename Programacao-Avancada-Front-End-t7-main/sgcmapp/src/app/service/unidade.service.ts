...
export class UnidadeService implements ICrudService<Unidade>, IPageService<Unidade> {
  ...
  consultarPaginado(termoBusca?: string, paginacao?: RequisicaoPaginada): Observable<RespostaPaginada<Unidade>> {
    let url = `${this.apiUrl}/consultar`;
    let parametros = new HttpParams();
    ...
    return this.http.get<RespostaPaginada<Unidade>>(url, { params: parametros });
  }
