...
export class EspecialidadeService implements ICrudService<Especialidade>, IPageService<Especialidade> {
  ...
  consultarPaginado(termoBusca?: string, paginacao?: RequisicaoPaginada): Observable<RespostaPaginada<Especialidade>> {
    let url = `${this.apiUrl}/consultar`;
    let parametros = new HttpParams();
    ...
    return this.http.get<RespostaPaginada<Especialidade>>(url, { params: parametros });
  }
